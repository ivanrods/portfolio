...
function About() {
  return (
    <Container id="about" color="bg-neutral-950 ">
      <section
        data-aos="fade-up"
        className="flex flex-col gap-8 bg-neutral-900 p-6 md:p-8 border-2 border-neutral-600 rounded-xl lg:flex-row"
      >
        ...
        <article>
          ...
          <h2 className="text-lg lg:text-2xl font-medium py-4">
            Ivan Rodrigues
          </h2>
