function Project({ img, description, title, hrefGitHoub, hrefSite }) {
  return (
    <div className=" bg-neutral-900 flex flex-col gap-3 border-2 border-neutral-600 rounded-md overflow-hidden px-4 py-4 transition duration-300 hover:bg-neutral-800 hover:bg-neutral-800">
