...
function Projects() {
  const projects = [
    ...
    },
    {
      ...
      title: "Cadastros",
      description:
        "Aplicação web Full Stack completa para exploração e cadastro de usuários e cidades, permitindo autenticação de usuários e gerenciamento de dados. Frontend desenvolvido com React e Material-UI, Backend desenvolvido com Node.js, Express e Jest para testes, utilizando JWT para controle de acesso e PostgreSQL para armazenamento de dados.",
      stacks: [
        "React ",
        " Material-UI ",
        " Yup ",
