export const tech = {
  ...
  zod: "Zod é uma biblioteca de validação de esquema de dados para JavaScript e TypeScript.",
  jwt: "JWT, ou JSON Web Token, é um padrão aberto para criar tokens de acesso de forma segura entre duas partes, geralmente um cliente e um servidor.",
};
